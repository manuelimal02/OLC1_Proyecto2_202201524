        ...
        if (this.valor == null && this.tamano1!= undefined && this.tamano2!=undefined) {
            switch (this.tipo_dato.getTipo()) {
                case tipo_dato.ENTERO:
                    let matriz: Nativo[][] = new Array<Array<Nativo>>(this.tamano1);
                    for (let i = 0; i < matriz.length; i++) {
                        matriz[i] = new Array<Nativo>(this.tamano2);
                ...
                case tipo_dato.DECIMAL:
                    let matriz1: Nativo[][] = new Array<Array<Nativo>>(this.tamano1);
                    for (let i = 0; i < matriz1.length; i++) {
                        matriz1[i] = new Array<Nativo>(this.tamano2);
                ...
                case tipo_dato.BOOLEANO:
                    let matriz3: Nativo[][] = new Array<Array<Nativo>>(this.tamano1);
                    for (let i = 0; i < matriz3.length; i++) {
                        matriz3[i] = new Array<Nativo>(this.tamano2);
                ...
                case tipo_dato.CADENA:
                    let matriz4: Nativo[][] = new Array<Array<Nativo>>(this.tamano1);
                    for (let i = 0; i < matriz4.length; i++) {
                        matriz4[i] = new Array<Nativo>(this.tamano2);
                ...
                case tipo_dato.CARACTER:
                    let matriz5: Nativo[][] = new Array<Array<Nativo>>(this.tamano1);
                    for (let i = 0; i < matriz5.length; i++) {
                        matriz5[i] = new Array<Nativo>(this.tamano2);
