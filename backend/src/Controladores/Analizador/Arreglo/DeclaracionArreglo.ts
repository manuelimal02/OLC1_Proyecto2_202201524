...
export default class DeclaracionArreglo extends Instruccion {
    ...
    private tamano: number | undefined

    constructor(tipo: Tipo, fila: number, columna: number, identificador: string , valor: Instruccion[], tamano?: number) {
        ...
        if (this.valor == null && this.tamano!= undefined) {
            switch (this.tipo_dato.getTipo()) {
                case tipo_dato.ENTERO:
                    let arreglo: Nativo[] = new Array<Nativo>(this.tamano);
                ...
                case tipo_dato.DECIMAL:
                    let arreglo2: Nativo[] = new Array<Nativo>(this.tamano);
                ...
                case tipo_dato.BOOLEANO:
                    let arreglo3: Nativo[] = new Array<Nativo>(this.tamano);
                ...
                case tipo_dato.CADENA:
                    let arreglo4: Nativo[] = new Array<Nativo>(this.tamano);
                ...
                case tipo_dato.CARACTER:
                    let arreglo5: Nativo[] = new Array<Nativo>(this.tamano);
